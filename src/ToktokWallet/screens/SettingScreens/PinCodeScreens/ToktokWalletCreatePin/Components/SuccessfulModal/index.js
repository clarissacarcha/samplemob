  ...
  return (
    <View style={[styles.content]}>
      ...
      <Text
        ...
        You have secured your toktokwallet. Make sure to remember your TPIN and do not share it with anyone.
      </Text>
    </View>
  );
};
  ...
  return (
    <Modal visible={modalVisible} onRequestClose={closeModal}>
      ...
      <View style={styles.container}>
        {tokwaAccount.pinCode ? onCashIn ? <NewPIN /> : <UpdatePIN /> : <NewPIN />}
          ...
          <View>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                Use a <Text style={{color: COLOR.YELLOW}}>secure</Text> TPIN combination
              </Text>
            </Reminder>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                <Text style={{color: COLOR.YELLOW}}>Remember</Text> your TPIN
              </Text>
            </Reminder>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                <Text style={{color: COLOR.YELLOW}}>Never share</Text> your TPIN with anyone
              </Text>
            </Reminder>
          </View>
        </View>
