        ...
        <View style={styles.container}>
            <ScrollView style={styles.content}>
                    ...
                    <View style={{position: 'relative',marginTop: 40,padding: 16,}}>
                        ...
                        />
                         {
                            pinCodeAttempt > 0 && <Text style={{fontFamily: FONT.REGULAR,color:"red",alignSelf:"center",fontSize: 12,textAlign:'center'}}>Incorrect PIN. You can try {numWordArray[pinCodeAttempt]} ({pinCodeAttempt}) more {pinCodeAttempt == 1 ? "time" : "times"} before your account will be temporarily suspended.</Text>
                        }
