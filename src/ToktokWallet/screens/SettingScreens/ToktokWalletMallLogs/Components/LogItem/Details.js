...
const Details = ({
  ...
  return (
    ...
    >
      <View>
        <Text style={styles.labelText}>Status of toktokmall: Success</Text>
        ...
        { refDate && <Text style={styles.labelText}>toktokmall Date: {refDate}</Text>}
        { refDate && <Text style={styles.labelText}>toktokmall Time: {refTime}</Text>}
      </View>
    </TransactionModal>
  )
}
