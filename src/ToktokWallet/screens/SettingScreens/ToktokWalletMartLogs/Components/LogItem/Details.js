...
const Details = ({
  ...
  return (
    ...
    >
      <View>
        <Text style={styles.labelText}>Status of toktokmart: Success</Text>
        ...
        { refDate && <Text style={styles.labelText}>toktokmart Date: {refDate}</Text>}
        { refDate && <Text style={styles.labelText}>toktokmart Time: {refTime}</Text>}
      </View>
    </TransactionModal>
  )
}
