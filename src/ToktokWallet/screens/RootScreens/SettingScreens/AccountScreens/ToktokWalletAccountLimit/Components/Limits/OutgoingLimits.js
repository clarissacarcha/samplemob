        ...
        <>
         { limits?.daily && 
            <Card
                ...
                bottomLabel={()=> (
                    <>
                    {!limits?.monthly &&  <Text style={styles.labelRegularSmall}>No limit for Monthly Outgoing Transactions</Text>}
                    {!limits?.annual &&  <Text style={styles.labelRegularSmall}>No limit for Annual Outgoing Transactions</Text>}
                    </>
                )}
            />
         }
