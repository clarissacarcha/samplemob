...
export const toktokwalletLabel = ()=> {
    return <Text style={{...styles.labelRegular,color: COLOR.YELLOW}}>toktok<Text style={{...styles.labelRegular,color: COLOR.ORANGE}}>wallet</Text></Text>
}
...
export const Limits = ()=> {
    ...
    return (
        <View style={styles.container}>
            <Card 
                title="Wallet Limit"
                description={()=><Text style={styles.labelRegular}>Maximum amount that can be kept in your {toktokwalletLabel()}.</Text>}
            ...
            />
            {
                ...
                <>
                <OutgoingLimits
                    limits={limits?.outgoing}
                    used={usedLimits?.outgoing}
                />
                <IncomingLimits
                    limits={limits?.incoming}
                    used={usedLimits?.incoming}
                />
                </>
            }
        </View>
