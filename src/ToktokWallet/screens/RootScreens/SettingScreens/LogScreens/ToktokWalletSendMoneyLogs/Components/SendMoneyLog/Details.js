...
const Details = ({transaction, visible, setVisible}) => {
  const {refNo, refDate, name, phrase, amount, status, details} = transaction;
      ...
      <View>
        ...
        <View style={{marginTop: 15}}>
          <Text style={styles.labelText}>
            <Text style={{fontFamily: FONT.BOLD}}>Status:</Text> Success
          </Text>
          <Text style={styles.labelText}>
          ...
          {refNo && (
            <Text style={styles.labelText}>
              <Text style={{fontFamily: FONT.BOLD}}>Toktokwallet Reference Number:</Text> {refNo}
            </Text>
          )}
          {refDate && (
            <Text style={styles.labelText}>
