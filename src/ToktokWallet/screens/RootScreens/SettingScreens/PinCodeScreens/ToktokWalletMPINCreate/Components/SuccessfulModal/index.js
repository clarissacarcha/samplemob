...
const NewPIN = () => {
  return (
    <View style={[styles.content]}>
      ...
      <Text
        style={{color: '#212529', marginTop: 5, fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M, textAlign: 'center'}}>
        You have secured your toktokwallet. Make sure to remember your MPIN and do not share it with anyone.
      </Text>
    </View>
  );
};
          ...
          <View>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                Use a <Text style={{color: COLOR.YELLOW}}>secure</Text> MPIN combination
              </Text>
            </Reminder>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                <Text style={{color: COLOR.YELLOW}}>Remember</Text> your MPIN
              </Text>
            </Reminder>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                <Text style={{color: COLOR.YELLOW}}>Never share</Text> your MPIN with anyone
              </Text>
            </Reminder>
            <Reminder>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M}}>
                If you think your MPIN is no longer a secret,{' '}
              </Text>
            </Reminder>
            <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M, marginLeft: 28}}>
              <Text style={{color: COLOR.YELLOW}}>change your</Text> MPIN immediately
            </Text>
          </View>
        </View>
        <View>
