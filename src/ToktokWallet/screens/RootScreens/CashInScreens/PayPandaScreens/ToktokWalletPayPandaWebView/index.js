...
export const ToktokWalletPayPandaWebView = ({navigation, route}) => {
  ...
  navigation.setOptions({
    headerLeft: () => <HeaderBack onBack={goBack} />,
    headerTitle: () => <HeaderTitleRevamp />,
  });
                  ...
                  if (checkreturnurl != -1) {
                    ...
                    if (checkurl != url) {
                      setCashInLogParams({
                        ...
                        accountNumber: route.params.mobile_number,
                        ...
                        paymentMethodKey: route.params.paymentMethodKey,
                      });
