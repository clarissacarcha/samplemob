...
export const ReceiptDetails = ({route}) => {
  ...
  const {referenceNumber, createdAt, amount, providerServiceFee, payer, paypandaReferenceNumber, accountNumber} =
    ...
    <>
      ...
      <View>
        ...
        <View style={[styles.bodyContainer, styles.marginBottom15]}>
          ...
          <Text style={styles.description}>{paypandaReferenceNumber}</Text>
        </View>
        <View style={[styles.bodyContainer, styles.marginBottom15]}>
        ...
        <View style={[styles.bodyContainer, styles.marginBottom15]}>
          ...
          <Text style={styles.description}>{payer}</Text>
        </View>
        <View style={[styles.bodyContainer, styles.marginBottom15]}>
        ...
        <View style={[styles.bodyContainer, styles.marginBottom15]}>
          ...
          <Text style={styles.description}>
            {currencyCode}
            {numberFormat(parseFloat(providerServiceFee) + parseFloat(amount))}
          </Text>
        </View>
