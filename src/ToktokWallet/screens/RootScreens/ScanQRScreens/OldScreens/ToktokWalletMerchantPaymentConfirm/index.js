...
//SELF IMPORTS
import {EnterAmount, EnterNote, ProceedButton} from './Components';

const {COLOR, FONT_FAMILY: FONT, FONT_SIZE, SIZE, MARGIN} = CONSTANTS;

export const ToktokWalletMerchantPaymentConfirm = ({navigation, route}) => {
      ...
      <CheckIdleState>
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            <ScrollView contentContainerStyle={{flexGrow: 1}} style={{flex: 1, backgroundColor: 'white'}}>
              <View style={styles.merchantInfo}>
                ...
                <View style={{marginTop: 10, alignItems: 'center'}}>
                  <Text style={{fontFamily: FONT.BOLD, fontSize: FONT_SIZE.L}}>{branch.branchName}</Text>
                  <Text style={{fontFamily: FONT.BOLD, fontSize: FONT_SIZE.M, color: COLOR.ORANGE}}>
              ...
              <View style={{paddingHorizontal: 16}}>
                ...
                {merchant.paymentType === 1 && (
                  <Text style={{fontFamily: FONT.REGULAR, fontSize: FONT_SIZE.M, marginBottom: 10}}>
