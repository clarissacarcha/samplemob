...
const SuccessfulModal = ({
  ...
  return (
    <Modal animationType="fade" visible={successModalVisible} onRequestClose={Proceed}>
      <Receipt
        ...
        <View style={styles.recipientInfo}>
          <TransactionInfo label="Merchant/Branch" value={`${branch.branchName} (${terminal.terminalName})`} />
          <TransactionInfo
            label="Account Name"
            value={`${tokwaAccount.person.firstName} ${tokwaAccount.person.lastName}`}
          />
