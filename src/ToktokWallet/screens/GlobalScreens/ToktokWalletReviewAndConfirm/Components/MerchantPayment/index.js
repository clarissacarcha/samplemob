    ...
    <View style={styles.container}>
      <View style={styles.merchantInfo}>
        ...
        <View style={{marginTop: 10, alignItems: 'center'}}>
          <Text style={{fontFamily: FONT.BOLD, fontSize: FONT_SIZE.L}}>
            {merchant.merchantName} {branch.branchName}
          </Text>
      ...
      <View style={styles.information}>
        ...
        <View style={{flex: 1, alignItems: 'flex-end'}}>
          <Text style={{fontFamily: FONT.BOLD, fontSize: FONT_SIZE.M, textAlign: 'right'}}>
      ...
      <View style={styles.information}>
        ...
        <View style={{flex: 1, alignItems: 'flex-end'}}>
          <Text style={{fontFamily: FONT.BOLD, fontSize: FONT_SIZE.M, textAlign: 'right'}}>
            ₱{numberFormat(+amount + +serviceFee)}
          </Text>
        </View>
      </View>
