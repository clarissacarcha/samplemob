...
import {View, Text, StyleSheet, TextInput, TouchableOpacity, Image, Keyboard, Platform} from 'react-native';
    ...
    onError: error => {
      ...
      if (graphQLErrors[0]?.message == 'Invalid MPincode') {
        ...
        return setErrorMessage(
          `Incorrect MPIN. You can try ${numWordArray[attempt]} (${attempt}) more ${
            attempt == 1 ? 'time' : 'times'
          } before your account will be temporarily blocked.`,
        );
      }
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Image style={styles.tokwaLogo} source={tokwaLogo} resizeMode="contain" />
          <Text style={{fontSize: FONT_SIZE.M, fontFamily: FONT.BOLD, alignSelf: 'center', marginTop: 20}}>
            Enter MPIN
          </Text>
          ...
          <View style={{justifyContent: 'center', alignItems: 'center', flex: 1}}>
            <TouchableOpacity style={{}} onPress={forgotPIN}>
