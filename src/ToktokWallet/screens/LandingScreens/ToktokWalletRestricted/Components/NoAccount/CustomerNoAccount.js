    ...
    <>
      <ImageBackground source={LinearGradient} resizeMode="cover" style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.verifyWalletText}>Create Your Account</Text>
          <Text style={styles.clickVerifyText}>
            Enjoy the convenience of cashless transactions anytime, anywhere. Manage contactless payments fast and easy
            checkouts.
          </Text>
