...
export const RejectedKyc = ({navigation}) => {
    ...
    <>
      <ImageBackground source={LinearGradient} resizeMode="cover" style={styles.container}>
        <View style={styles.content}>
          ...
          <Text style={styles.verifyWalletText}>Application has been rejected</Text>
          <Text style={styles.clickVerifyText}>
            Please check email for further details or click “Create Account” to try again.
          </Text>
