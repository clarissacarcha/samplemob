...
export const POST_GENERATE_QR_CODE = gql`
  mutation postGenerateQRCode($input: PostGenerateQRCodeInput) {
    postGenerateQRCode(input: $input) {
      encryptedQRToken
    }
  }
`;
...
export const GET_ACCOUNT_QR_CODES = gql`
  query {
    getAccountQrCodes {
      id
      accountId
