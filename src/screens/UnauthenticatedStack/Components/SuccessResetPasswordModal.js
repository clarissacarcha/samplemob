...
export const SuccessResetPasswordModal = ({isVisible, setVisible, goToLogin}) => {
  return (
        ...
        <View style={styles.card}>
          <View style={styles.container}>
            ...
            <Text style={styles.modalDescription}>
              Your password has now been successfully changed. You may now log in using your new password.
            </Text>
