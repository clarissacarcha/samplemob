...
const ChangePassword = ({ navigation, session,route }) => {
    ...
    return (
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <ChangePasswordSuccessModal navigation={navigation} successfulChangePassword={successfulChangePassword} setSuccessfulChangePassword={setSuccessfulChangePassword} />
            <ChangePasswordConfirmationModal navigation={navigation} showConfirmationChangePassword={showConfirmationChangePassword} setConfirmationChangePassword={setConfirmationChangePassword} patchUserChangePassword={patchUserChangePassword} />
                ...
                <View style={{ alignItems: 'center' }}>
                    ...
                    <View style={{ marginBottom: 16 }}>
                        <View style={[styles.textInput, {
                            ...
                            borderColor: onFocusNewPassword ? CONSTANTS.COLOR.ORANGE : invalidPassword.length > 0 ? CONSTANTS.COLOR.RED : "",
                            flexDirection: 'row',
                            alignItems: 'center',
                            ...
                            />
                            <MCIcons name={!secureNewPassword ? "eye" : "eye-off-outline"} size={15} color={CONSTANTS.COLOR.DARK} onPress={() => { setSecureNewPassword(!secureNewPassword) }} />
                        </View>
                    ...
                    <View style={{ marginBottom: 16 }}>
                        <View style={[styles.textInput, {
                            ...
                            borderColor: onFocusConfirmPassword ? CONSTANTS.COLOR.ORANGE : !passwordMatch ? CONSTANTS.COLOR.RED : "",
                            flexDirection: 'row',
                            alignItems: 'center',
                            justifyContent: "space-between"
                        }]}>
                            ...
                            />
                            <MCIcons name={!secureConfirmPassword ? "eye" : "eye-off-outline"} size={15} color={CONSTANTS.COLOR.DARK} onPress={() => { setSecureConfirmPassword(!secureConfirmPassword) }} />
                        </View>
                        {!passwordMatch && <Text style={{ color: CONSTANTS.COLOR.RED, fontSize: CONSTANTS.FONT_SIZE.S }}>Passwords do not match</Text>}
                    </View>
                </View>
                <View>
                    <TouchableOpacity style={styles.button} onPress={() => { onSavePasswordPress() }}>
