        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <View style={[styles.textInput, {
                        ...
                        borderColor: onFocusCurrentPassword ? CONSTANTS.COLOR.ORANGE : invalidCurrentPassword ? CONSTANTS.COLOR.RED : "",
                        flexDirection: 'row',
                        alignItems: 'center',
                    ...
                    {invalidCurrentPassword && <Text style={{ color: CONSTANTS.COLOR.RED, fontSize: CONSTANTS.FONT_SIZE.S }}>Password is incorrect</Text>}
