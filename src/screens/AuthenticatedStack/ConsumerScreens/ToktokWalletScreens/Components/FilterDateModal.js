...
import { FONT_REGULAR , FONT_MEDIUM, DARK, COLOR, BUTTON_HEIGHT, SIZES, FONTS, COLORS } from '../../../../../res/constants'
              ...
              <View style={{flex: 1 ,justifyContent: "center",alignItems: "center" ,backgroundColor: "rgba(0,0,0,0.7)"}}> 
                  <View style={{width: "95%"  , backgroundColor: "white",padding: 10,  shadowColor: '#000',
                    ...
                    >
                        ...
                        <Text style={{fontFamily: FONTS.BOLD,fontSize: SIZES.XL,color: COLORS.DARK}}>Date From</Text>
                        ...
                        <Text style={{fontFamily: FONTS.BOLD,fontSize: SIZES.XL,marginTop: 20}}>Date To</Text>
