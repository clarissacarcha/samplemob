...
import { GET_MY_ACCOUNT , GET_TRANSACTIONS } from '../../../../../graphql/toktokwallet'
...
const CheckWalletAccountRestriction = ({children ,saveTokwaAccount , getTokwaTransactions,setLoading})=> {
