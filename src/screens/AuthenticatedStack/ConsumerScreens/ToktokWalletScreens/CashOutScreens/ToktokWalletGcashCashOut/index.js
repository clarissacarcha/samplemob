...
import { BUTTON_ORANGE, COLOR, DARK, FONT_LIGHT, FONT_MEDIUM, FONT_REGULAR, SIZES, MEDIUM } from '../../../../../../res/constants';
        ...
        >
            ...
            <View style={styles.cashoutbutton}>
                    <TouchableOpacity 
                        ...
                        style={{height: "100%",width: "100%",backgroundColor: (amount != "" && amount <= walletinfo.balance && amount >= 1 ) ? BUTTON_ORANGE : "gray", borderRadius: 10, justifyContent: "center",alignItems: "center"}}
                    >
                        <Text style={{color: (amount != "" && amount <= walletinfo.balance && amount >= 1 ) ? "black" : "white",fontSize: SIZES.M,fontFamily: FONT_MEDIUM}}>Cash Out</Text>
                    </TouchableOpacity>
            </View>
            </View>
        </KeyboardAvoidingView> 
