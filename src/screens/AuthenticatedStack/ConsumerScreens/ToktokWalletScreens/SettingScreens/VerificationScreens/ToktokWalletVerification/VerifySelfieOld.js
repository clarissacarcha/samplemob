    ...
    const ImageIDSet = ()=> (
        <View style={{
            ...
            transform: [
                ...
                />
                <TouchableOpacity onPress={()=>navigation.push("ToktokWalletSelfieImageCamera", {setImage})} style={{position:"absolute",bottom: 15,width: 180,height: 20, justifyContent:"center",alignItems:"center",alignSelf:"center",  transform: [
                {
                    scaleX: -1,
                }
            ]}}>
