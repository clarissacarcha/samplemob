...
const LeavePromptModal = ({visible,setVisible, onConfirm})=> {
    return (
        <>
        ...
        >
            <View style={styles.content}>
                    <View style={styles.closePrompt}>
                        <View style={{flex: 1}}>
                            <Text style={{fontFamily: FONTS.BOLD, fontSize: SIZES.L}}>Are you sure you want to leave?</Text>
                        </View>
                        ...
                        <TouchableOpacity onPress={()=>setVisible(false)} style={{borderRadius: 5, marginRight: 10, height: "100%",backgroundColor:"#F7F7FA",flex: 1,justifyContent:"center",alignItems:"center"}}>
                           ...
                           <TouchableOpacity onPress={()=>{
                               setVisible(false)
                               onConfirm()
                           }} style={{borderRadius: 5, marginLeft: 10, height: "100%",backgroundColor:COLORS.YELLOW,flex: 1,justifyContent:"center",alignItems:"center"}}>
                                <Text style={{fontFamily: FONTS.BOLD,fontSize: SIZES.L ,color: COLORS.DARK}}>Yes</Text>
                           </TouchableOpacity>
                        </View>
                    </View>
            </View>
