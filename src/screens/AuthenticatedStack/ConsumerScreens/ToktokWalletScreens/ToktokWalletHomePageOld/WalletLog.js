                    ...
                    return (
                        <View style={styles.transaction}>
                            ...
                            <View style={styles.transactionDetails}>
                                ...
                                <Text style={{fontSize: SIZES.M,fontFamily: FONT_REGULAR}}>{title}</Text>
                                <Text style={{color: "#909294",fontSize: SIZES.S,fontFamily: FONT_REGULAR}}>{phrase}</Text>
                            </View>
                            <View style={styles.transactionAmount}>
                                <Text style={{fontSize: SIZES.M,fontFamily: FONT_REGULAR , color: amountcolor}}>{amountprefix} PHP {numberFormat(item.amount)}</Text>
