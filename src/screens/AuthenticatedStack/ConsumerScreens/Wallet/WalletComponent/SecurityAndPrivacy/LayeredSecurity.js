        ...
        <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <View style={{marginTop: 10,paddingBottom: 20}}>
                            <ContentItem message="We protect your wallet by offering toktok wallet PIN authentication. It prevents unauthorized access to your account." label="toktok wallet PIN" icon={require('../../../../../../assets/icons/magnifying.png')}/>
                            ...
                            <ContentItem message="Notifications are sent out after every toktok wallet payment. Keeping you aware of all your transactions." label="Instant payment alerts" icon={require('../../../../../../assets/icons/magnifying.png')}/>
