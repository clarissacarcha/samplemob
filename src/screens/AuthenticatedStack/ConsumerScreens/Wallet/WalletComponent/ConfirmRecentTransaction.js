...
const ConfirmRecentTransaction = ({recentTransfer})=> {
                ...
                <View style={styles.modalbody}>
                    <View style={styles.modalconfirmdetails}>
                         <View style={{flexDirection: "row",paddingVertical: 6,borderColor: "silver",width: "100%",}}>
                            ...
                            <View style={{flex: 1}}>   
                                <Text style={{color: "gray",fontSize: SIZES.M,alignSelf: "flex-end",fontFamily: FONT_REGULAR}}>{
                                `${recentTransfer.destinationInfo.firstName} ${recentTransfer.destinationInfo.middleName ? recentTransfer.destinationInfo.middleName + " " : ""}${recentTransfer.destinationInfo.lastName}`
                                } 
                                </Text>
                            </View>  
                        </View>
                        ...
                        <View style={{flexDirection: "row",paddingVertical: 6,borderColor: "silver",}}>
                            ...
                            <View style={{flex: 1}}>   
                                <Text style={{color: "gray",fontSize: SIZES.M,alignSelf: "flex-end",fontFamily: FONT_REGULAR}}>PHP {numberFormat(recentTransfer.amount)}</Text>
                            </View>  
                        </View>
                        <View style={{flexDirection: "row",paddingVertical: 6,}}>
                            ...
                            <View style={{flex: 1}}>   
                                <Text style={{fontFamily: FONT_MEDIUM,alignSelf: "flex-end", fontSize: SIZES.M}}>PHP {numberFormat(recentTransfer.amount)}</Text>
                            </View>  
                        </View>
                </View>
            </View>
...
export default ConfirmRecentTransaction