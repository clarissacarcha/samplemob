...
const MessageModal = ({msgModalVisible, setMsgModalVisible, modalMessage})=> {
    const title = modalMessage == "Wallet not found" ? "Recipient does not have toktokwallet" : "Recipient does not have toktok app"
    const message = modalMessage == "Wallet not found"? 'Tell your recipient to create their toktokwallet first' : 'Tell them to download and install toktok app'
