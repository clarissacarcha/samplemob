                ...
                <View style={styles.modalbody}>
                    <View style={styles.modalconfirmdetails}>
                        <View style={{flexDirection: "row",paddingVertical: 6,borderColor: "silver",width: "100%",}}>
                            <View style={{flex: 1}}>    
                                <Text style={{color: "gray",fontSize: SIZES.M, fontFamily: FONT_REGULAR}}>Cash in method</Text>
                            </View>
                            <View style={{flex: 1}}>   
                                <Text style={{color: "gray",fontSize: SIZES.M,alignSelf: "flex-end",fontFamily: FONT_REGULAR}}>PayPanda</Text>
                            </View>  
                        </View>
                        <View style={{flexDirection: "row",paddingVertical: 6,borderColor: "silver",}}>
                            <View style={{flex: 1}}>    
                                <Text style={{color: "gray",fontSize: SIZES.M,fontFamily: FONT_REGULAR}}>Cash in amount</Text>
                            </View>
                            <View style={{flex: 1}}>   
