                        ...
                        <View style={{flexDirection: 'row'  }}>
                            ...
                            {/* {[1, 2, 3, 4, 5, 6].includes(delivery.status) && ( */}
                                ...
                                <View style={{flex: 1, flexDirection: 'row', alignItems:'center', justifyContent: 'flex-end'}}>
                                    ...
                                    <Text style={{fontFamily: FONT.REGULAR, color: constants.COLOR.YELLOW, fontSize: constants.FONT_SIZE.M}}>
                                        toktok<Text style={{fontFamily: FONT.REGULAR, color: constants.COLOR.ORANGE, fontSize: constants.FONT_SIZE.M}}>wallet</Text>
                                    </Text>
                                </View>
                            {/* )} */}
                        </View>
