...
export const BookingNote = ({booking}) => {
  return (
      ...
      <View style={styles.directionsBox}>
        <View style={styles.directionDetail}>
          ...
          <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
            <View>
              <Text style={{fontFamily: FONT.REGULAR, fontSize: constants.FONT_SIZE.M}}>Note to Driver</Text>
              <Text style={styles.items}>{booking.notes}</Text>
            </View>
          </View>
        </View>
      </View>
