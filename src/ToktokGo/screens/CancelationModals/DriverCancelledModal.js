        ...
        <View style={styles.card}>
          <View style={styles.container}>
            ...
            <Text style={styles.modalDescription}>
              We're sorry ka-toktok, ang inyong toktok driver ay nag-cancel sapagkat kayo ay hindi dumating sa pick-up
              location. May No Show Fee na macha-charge sayo to compensate the driver. Would you like to pay now?
            </Text>
