 ...
 */
 ...
 export const ActivitiesCard = ({ delivery, onPress, lastItem = false }) => {
     ...
     const conditionalFontFamily = [2, 3, 4, 5].includes(delivery.status) ? constants.FONT_FAMILY.BOLD : constants.COLOR.BLACK;
                         ...
                         <View style={headerDesign()}>
                             <View style={{ flex: 1, flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{width: 150}}>
                                    <Text style={{fontSize: constants.FONT_SIZE.M}}>Delivery ID 
                                    <Text style={{color: constants.COLOR.YELLOW, fontSize: constants.FONT_SIZE.M, fontFamily: constants.FONT_FAMILY.BOLD}}> FLKHD{delivery.id}</Text></Text>
                             ...
                             <View
                                 ...
                                 <View style={{ flexDirection: 'row', paddingVertical: 10 }}>
                                     ...
                                     <View style={{ justifyContent: 'center', paddingRight: 8, paddingBottom:10 }}>
                                         ...
                                         <FA5Icon name="map-marker-alt" size={15} color={constants.COLOR.ORANGE} style={{ marginLeft: 1,paddingTop:5 }} />
                                     </View>
                                     <View style={{ flex: 1 }}>
                                         {/*-------------------- SENDER DETAILS --------------------*/}
                                         <View
