...
import { GET_TORECEIVE_TRANSACTIONS } from '../../../../../graphql/toktokmall/model';
...
export const ToRecieveItem = ({fulldata, shop}) => {
          ...
          <View style={styles.renderItemSubContainer}>
            <View style={styles.renderItemFirstContainer}>
              ...
              <View style={styles.renderItemFCLeft}>
                ...
                <Text style={styles.renderItemFCLeftText}>Order to receive</Text>
              </View>
            </View>
