  ...
  return (
      ...
      <View style={{flexDirection: 'row', backgroundColor: active ? '#fff' : '#FFFCF4'}}>
        ...
        <View style={{flex: 8, paddingVertical: 20, paddingHorizontal: 0}}>
          <Text style={{fontSize: 14}}>{data?.action}</Text>
          <Text style={{fontSize: 12, color: "#9E9E9E"}}>{data.content.split("&id")[0]}<Text style={{color: "#F6841F", fontSize: 12}}>{data.id}</Text> {data.content.split("&id")[1]}</Text>
        </View>
