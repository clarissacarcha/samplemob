...
export default ({y}: HeaderProps) => {
  ...
  useCode(() => set(toggle, greaterThan(y, 100 )), [toggle, y]) 
    ...
    <Animated.View style = {{ opacity }}>
      ...
      >
        <View style={{flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end', }}>
          <TouchableOpacity 
            // onPress={onBack} 
            style={{flex: 0, alignItems: 'center', paddingHorizontal: 15, paddingTop: 8}}>
          ...
          <View style={{flex: 8, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 0, paddingTop: 8}}>
            ...
            // onPress={onPress} 
            style={{flex: 0, backgroundColor: '#fff', width: '100%', padding: 4, elevation: 0, flexDirection: 'row', borderRadius: 6}}>
