...
const Tab = ({index, label, active, onPress}) => {
    ...
    return (
        <>
            <TouchableOpacity onPress={onButtonPress} style={{backgroundColor: bgcolor, paddingVertical: 15, alignItems: 'center', justifyContent: 'center', borderRadius: 8}}>
                <Text style={{color: txtcolor, fontSize: 12}}>{label}</Text>
            </TouchableOpacity>
        </>
    )
}
