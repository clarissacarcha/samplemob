...
import VoucherImage from '../../../../../../assets/images/voucherDelivery.png';
// import VoucherImage from '../../../../../../'
import moment from 'moment';
import normalize from 'react-native-normalize';

export const VoucherCard = ({data, navigation, onPressActionButton, loading, setSelectedVoucher}) => {
  const getComputed = () => {
