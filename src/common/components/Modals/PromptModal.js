...
import TOKTOKLOAD_ONBOARDING from 'toktokload/assets/images/onboarding-logo.png';
...
export const PromptModal = ({type, title, message, visible, setVisible, onPress, children, event}) => {
    ...
    <Modal
      ...
      <View style={styles.modalBody}>
        <View style={styles.content}>
          ...
          {!!title && (
            <Text style={[styles.successText, {color: event === 'TOKTOKWALLET' ? 'black' : titleColor()}]}>
              {title}
            </Text>
          )}
          ...
          <TouchableOpacity
            ...
            <Text style={[styles.btnText, {color: event === 'TOKTOKWALLET' ? 'black' : 'white'}]}>
              {type === 'onboarding' ? 'Start' : 'OK'}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
