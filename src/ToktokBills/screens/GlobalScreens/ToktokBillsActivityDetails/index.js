        ...
        <View>
          <View style={{ marginBottom: moderateScale(10) }}>
              ...
              <View style={styles.accountInfo}>
                <Text style={styles.accountColor}>{billerDetails?.secondFieldName}:{' '}{destinationIdentifier}</Text>
              </View>
              <View style={styles.accountInfo}>
                <Text style={styles.accountColor}>{billerDetails?.firstFieldName}:{' '}{destinationNumber}</Text>
              </View>
              <View style={styles.accountInfo}>
