...
const styles = StyleSheet.create({
  detailsImage: {
    resizeMode: 'cover',
    height: Platform.OS === 'android' ? moderateScale(150 + getStatusbarHeight) : moderateScale(120),
  },
  detailsContainer: {
    zIndex: 1,
    height: Platform.OS === 'android' ? moderateScale(235 + getStatusbarHeight) : scale(210),
  },
});
