...
import { AdminGraphQLModules } from "../../graphql_modules";
import Models from "../../models";
import { pubsub } from "../pubsub";

const MyGraphQLModule = new GraphQLModule({
  imports: Object.values(AdminGraphQLModules),
});

const baseUrl = `${process.env.PROTOCOL}://${process.env.HOST}:${process.env.PORT}/`;

export const mountAdminApolloOnExpressAndServer = (
  ...
  graphqlServer.applyMiddleware({ app: expressApp, path: "/admin/graphql" });
