...
//import model
const accountLevelType_1 = require("../controllers/accountLevelType");
...
], accountLevelType_1.AccountLevelType.create);
router.get("/read/:id", [
...
], accountLevelType_1.AccountLevelType.read);
router.put("/update", [
    express_validator_1.check("id")
        .notEmpty()
        .withMessage("ID is required"),
    express_validator_1.check("type")
        ...
        .isLength({ max: 45 })
        .withMessage("value should not exceed 45 characters")
], accountLevelType_1.AccountLevelType.update);
router.delete("/delete/:id", [
    express_validator_1.check('id')
        ...
        .isInt()
        .withMessage("Only number are allowed")
], accountLevelType_1.AccountLevelType.delete);
router.post("/list", [
...
], accountLevelType_1.AccountLevelType.list);
//export routes
