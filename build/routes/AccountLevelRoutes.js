...
//import model
const accountLevel_1 = require("../controllers/accountLevel");
...
], accountLevel_1.AccountLevel.read);
router.put("/update", [
    express_validator_1.check("id")
        .notEmpty()
        .withMessage("ID is required."),
...
router.delete("/delete/:id", [
    express_validator_1.check('id')
        ...
        .isInt()
        .withMessage("Only number are allowed")
], accountLevel_1.AccountLevel.delete);
router.post("/list", [
...
], accountLevel_1.AccountLevel.list);
//export routes
