...
exports.knexProfiler = (knex) => {
    ...
    knex
        ...
        const uid = query.__knexQueryUid;
        times[uid].endTime = performance_now_1.default();
    ...
    const printQueryWithTime = (uid) => {
        ...
        console.log(query.sql.cyan, ",", `[${query.bindings ? query.bindings.join(",") : ""}]`.cyan);
