...
export class RequirementTypeModel {
  static create = async (req: any) => {
    ...
    let values = [req.requirements, 1, date];
  ...
  static update = async (req: any) => {
    ...
    let values = [req.requirements, date, req.id];
  ...
  static delete = async (id: number) => {
    ...
    let query =
      "update tok_requirement_types set status = 0, updated_at = ? where id = ?";
  ...
  static list = async (req: any) => {
    ...
    const orderColumns = ["id", "requirements", "created_at", "updated_at"];
